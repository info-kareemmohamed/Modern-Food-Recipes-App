...
class MainViewModel @Inject constructor(
    ...
    var recipesResponse: MutableLiveData<NetworkResult<Object>> = MutableLiveData()
    ...
    private fun handleFoodRecipesResponse(response: Response<Object>): NetworkResult<Object>? {
        when {
